...
{
    public class GetActiveInvitationsTest
    {
        ...
        public GetActiveInvitationsTest()
        {
        ...
        public async Task GetInvitations_ReturnsOkObjectResult_WhenInvitationsExist()
        {
            ...
            _invitationServiceMock.Setup(svc => svc.GetActiveInvitations(userId)).ReturnsAsync(invitations);
