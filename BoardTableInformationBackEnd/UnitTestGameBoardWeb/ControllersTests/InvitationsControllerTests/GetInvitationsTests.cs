...
{
    public class GetInvitationsTests
    {
        ...
        public async Task GetInvitations_ReturnsOkObjectResult_WhenInvitationsExist()
        {
            ...
            _invitationServiceMock.Setup(svc => svc.GetInvitations(userId)).ReturnsAsync(invitations);

            // Act
            var result = await _invitationController.GetInvitations();
        ...
        public async Task GetInvitations_ReturnsOkObjectResult_WhenNoInvitationsExist()
        {
            ...
            _invitationServiceMock.Setup(svc => svc.GetInvitations(userId)).ReturnsAsync(new List<UserInvitationDto>());
