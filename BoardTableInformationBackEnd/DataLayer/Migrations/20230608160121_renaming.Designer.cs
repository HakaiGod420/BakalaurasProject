...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActiveGameEntityUserEntity", b =>
                {
                    b.Property<int>("ActiveGamesParticipantsActiveGameId")
                        .HasColumnType("int");

                    b.Property<int>("UsersUserId")
                        .HasColumnType("int");

                    b.HasKey("ActiveGamesParticipantsActiveGameId", "UsersUserId");
            ...
            modelBuilder.Entity("DataLayer.Models.ActiveGameEntity", b =>
                {
                    ...
                    b.Property<float>("Map_X_Coords")
                        .HasColumnType("real");

                    b.Property<float>("Map_Y_Coords")
                        .HasColumnType("real");
                    ...
                    b.Property<int>("RegisteredPlayerCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataLayer.Models.BoardGameEntity", b =>
                {
                    ...
                    b.Property<string>("Thumbnail_Location")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ActiveGameEntityUserEntity", b =>
                {
                    b.HasOne("DataLayer.Models.ActiveGameEntity", null)
                        .WithMany()
                        .HasForeignKey("ActiveGamesParticipantsActiveGameId")
